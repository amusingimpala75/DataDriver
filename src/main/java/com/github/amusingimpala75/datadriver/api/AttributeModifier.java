...
public class AttributeModifier {
    ...
    public AttributeModifier(EntityAttribute attrib, double amt, EntityAttributeModifier.Operation op) {
        this.attrib = attrib;
        this.amt = amt;
        this.op = op;
    }
    ...
    public void apply(StatusEffect e) {
        ...
        e.addAttributeModifier(attrib, UUID.randomUUID().toString(), amt, op);
    }
